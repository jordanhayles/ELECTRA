...
$result=filterTable($sql);   
    ...
    {
        $sql="SELECT * FROM `items`"; //show items
        $result=filterTable($sql);
    }
...
<form action="Itemlist.php" method="POST">
 ...
 <table width="500px">
     <tr>
       <td><input type=text class="border" name="search" placeholder="Search Item"></td><td><input type=submit class="Submit"  name="searchbtn" value="Search"></td><td><input type=submit style="background:green; height:40px;width:120px;color:#fcfcfd;" name="excel" value="Export to Excel">
        </td>
         </tr>
     <tr><td ><a href="Itemlist.php"><i class="fa fa-refresh" aria-hidden="true"></i> Refresh</a></td></tr>
     </table>
  <table class="t-view">
